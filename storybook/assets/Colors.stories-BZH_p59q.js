import{j as e}from"./jsx-runtime-D_zvdyIk.js";import"./index-D4lIrffr.js";const s=()=>{const d={primary:"#613CB0",secondary:"#FF8800",nutrien:"#9ad441",worldplay:"#00a4e4",shaw:"#0488c1",accent:"#00A3FF",background:"#F5F5F5",card:"#FFFFFF",text:"#333333"};return e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl font-heading mb-4",children:"Theme Colors"}),e.jsx("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4",children:Object.entries(d).map(([a,r])=>e.jsxs("div",{className:"border border-gray-300 rounded p-4 shadow-sm",children:[e.jsx("div",{className:"h-20 w-full rounded mb-2",style:{backgroundColor:r}}),e.jsx("p",{className:"font-semibold capitalize",children:a}),e.jsx("p",{className:"text-sm text-gray-600",children:r}),e.jsxs("p",{className:`text-sm text-${a}`,children:["Example Text (text-",a,")"]}),e.jsx("div",{className:`mt-1 p-1 rounded bg-${a}`,children:e.jsxs("p",{className:"text-xs text-white mix-blend-difference",children:["Example BG (bg-",a,")"]})})]},a))})]})};s.storyName="Colors";const m={title:"Theme/Colors",component:s};s.__docgenInfo={description:"",methods:[],displayName:"ThemeColors"};var n,t,o;s.parameters={...s.parameters,docs:{...(n=s.parameters)==null?void 0:n.docs,source:{originalSource:`() => {
  const colors = {
    primary: "#613CB0",
    secondary: "#FF8800",
    nutrien: "#9ad441",
